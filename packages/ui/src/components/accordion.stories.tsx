  ...
  render: (args: { [key: string]: any }) => (
    <Accordion {...args} type="single" collapsible>
      <AccordionItem value="item-1">
        ...
        <AccordionContent>Yes. This is a single item accordion that can be collapsed.</AccordionContent>
      </AccordionItem>
    </Accordion>
  ),
};
  ...
  render: (args: { [key: string]: any }) => (
    <Accordion {...args} type="single" defaultValue="item-1">
      <AccordionItem value="item-1">
        ...
        <AccordionContent>This accordion item is expanded by default using defaultValue.</AccordionContent>
      </AccordionItem>
      <AccordionItem value="item-2">
        <AccordionTrigger>Second item</AccordionTrigger>
        <AccordionContent>This is the second accordion item.</AccordionContent>
      </AccordionItem>
    </Accordion>
  ),
};
